...
function NgCertificateNew() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addDoc(collection(db, "ng_certificate"), newNgCertificate);
      toast.success("Янги Табиий газ мувафақиятли яратилди!");
      ...
      {isSubmitting ? (
        ...
        <div className="grid grid-cols-1 min-h-screen w-full">
          <div className="bg-[url('https://picsum.photos/1000/1300')] bg-cover bg-no-repeat bg-center lg:bg-none grid place-items-center">
            ...
            >
              ...
              <div className="flex justify-center items-center gap-5">
                <div className="form-control">
                  <label className="label">
                    <span className="label-text">ТГ сертификати рақами</span>
                  </label>
                  <input
                    name="number"
                    type="text"
            ...
            <Link to="/ngcertificate">Орқага</Link>
          </div>
        </div>
      )}
    </>
...
export default NgCertificateNew;
