...
function NamlikCertificateNew() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addDoc(collection(db, "nam_certificate"), newNamCertificate);
      ...
      {isSubmitting ? (
        ...
        <div className="grid grid-cols-1 min-h-screen w-full">
          <div className="bg-[url('https://picsum.photos/1000/1300')] bg-cover bg-no-repeat bg-center lg:bg-none grid place-items-center">
            ...
            <Link to="/namlikcertificate">Орқага</Link>
          </div>
        </div>
      )}
    </>
...
export default NamlikCertificateNew;
